...
with open("conformal_experiments_data/16rooms-policies/path_policies.pkl", "wb") as f:
    pickle.dump(path_policies, f)

with open("conformal_experiments_data/16rooms-policies/adj_list.pkl", "wb") as f:
    pickle.dump(adj_list, f)

with open("conformal_experiments_data/16rooms-policies/terminal_vertices.pkl", "wb") as f:
